/****************************************************************************
** Meta object code from reading C++ file 'ui_account.h'
**
...
#error "The header file 'ui_account.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 8), // "saveData"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "AccountWindow\0saveData\0"
};
...
void AccountWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AccountWindow *_t = static_cast<AccountWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject AccountWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AccountWindow.data,
      qt_meta_data_AccountWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
