...
const QMetaObject DataCollect::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_DataCollect.data,
      qt_meta_data_DataCollect,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DataCollect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DataCollect.stringdata0))
        return static_cast<void*>(const_cast< DataCollect*>(this));
